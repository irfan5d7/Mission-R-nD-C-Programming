...
char * mini_leaderboard(char *lesson1,char *lesson2,char *lesson3) {
	...
	return NULL;
	/*char *name1 = (char*)malloc(sizeof(char) * 3);
	char *name2 = (char*)malloc(sizeof(char) * 3);
	char *name3 = (char*)malloc(sizeof(char) * 3);
	int n1l1, n1l2, n1l3,n2l1,n2l2,n2l3,n3l1,n3l2,n3l3;
	for (i=1)
	*/
