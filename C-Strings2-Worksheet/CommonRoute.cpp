	...
	else
	{
		...
		l1 = l2 = k = *cost = 0 ;
			...
			for (i = 0; i < l1 - k; i++)
			{
				...
				{
					a = i, b = j;
					if (hacklist[a] != '\0' && codelist[b] != '\0')
					{
						if (hacklist[a] == codelist[b])
						{
							a++, b++, c = 1;
							while (hacklist[a] == codelist[b] && hacklist[a] != '\0'&&codelist[b] != '\0')
							{
								a++, b++, c++;
							}
							if (c > k)
